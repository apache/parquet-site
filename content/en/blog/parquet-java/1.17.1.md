...
The [latest version of parquet-java is 1.17.1](https://dist.apache.org/repos/dist/release/parquet/apache-parquet-1.17.1/apache-parquet-1.17.1.tar.gz).

For the changes, please check out the [Release on Github](https://github.com/apache/parquet-java/releases/tag/apache-parquet-1.17.1).
